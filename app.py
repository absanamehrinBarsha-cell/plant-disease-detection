...
/* Mobile-only analysis input layout fix */
@media (max-width: 700px) {
    ...
    .analysis-input-row .input-card *,
    .analysis-input-row .input-card .prose,
    ...
    .analysis-input-row textarea::placeholder {
        color: #587064 !important;
        opacity: 1 !important;
        -webkit-text-fill-color: #587064 !important;
    }
}
